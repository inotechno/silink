<?php
	...
	class Sumbangan extends CI_Controller {
				...
				$html .= '<tr style="cursor:pointer;" data-id="'.$dp->id_jenis.'">
								...
								<td class="text-center align-middle">
									...
									<div class="dropdown-menu">
			                            <a href="javascript:void(0);" class="dropdown-item edit_jenis" data-id="'.$dp->id_jenis.'" data-nama="'.$dp->nama_sumbangan.'" data-mulai="'.$dp->mulai_sumbangan.'" data-selesai="'.$dp->selesai_sumbangan.'"><span class="fa fa-pencil-alt"></span> Ubah Data</a>
			                            <a href="javascript:void(0);" class="dropdown-item hapus_jenis" data-id="'.$dp->id_jenis.'"><span class="fa fa-trash-alt"></span> Hapus Data</a>
			                        </div>
		                        </td>
			...
			$no = 1;
				...
				$html .= '<tr>
							<td class="text-center align-middle">
								...
								<div class="dropdown-menu">
		                            <a href="javascript:void(0);" class="dropdown-item edit_sumbangan" data-id="'.$dp->id_sumbangan.'" data-jenis="'.$dp->id_jenis.'" data-nilai="'.$dp->nilai_sumbangan.'" data-nama="'.$dp->id.'" data-tanggal="'.$dp->tanggal_sumbangan.'"><span class="fas fa-pencil-alt"></span> Ubah Data</a>
		                            <a href="javascript:void(0);" class="dropdown-item hapus_sumbangan" data-id="'.$dp->id_sumbangan.'"><span class="far fa-trash-alt"></span> Hapus Data</a>
		                        </div>
	                        </td>
	                        <td class="align-middle text-center">'.$no++.'</td>
		...
		public function save_jenis_sumbangan()
		{
			...
			helper_log("add", "membuat data jenis sumbangan");
		...
		public function edit_jenis_sumbangan()
		{
			...
			echo json_encode($result);
			helper_log("edit", "mengubah data jenis sumbangan");
		...
		public function hapus_jenis_sumbangan()
		{
			...
			helper_log("del", "menghapus data keuangan");
		...
		public function save_sumbangan()
		{
			...
			echo json_encode($result);
			helper_log("add", "membuat data sumbangan");
		...
		public function edit_sumbangan()
		{
			...
			echo json_encode($result);
			helper_log("edit", "mengubah data sumbangan");
		}
		...
		public function hapus_sumbangan()
		{
			...
			echo json_encode($result);
			helper_log("del", "menghapus data sumbangan");
