                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-warning">
                                <h4 class="card-title text-white">Daftar Penduduk Yang Belum di Verifikasi</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm align-middle">
                                        ...
                                        <button class="btn btn-sm btn-info" type="button" id="aktifcheck" style="display: none;">
                                            <span class="fas fa-arrow-alt-circle-up"></span> Aktif
                                        </button>

                                        <button class="btn btn-sm btn-danger" type="button" id="hapuscheck" style="display: none;">
                                            <span class="fas fa-trash-alt"></span> Delete
                                        </button>
                                        
                                    </div>
                                    <div class="col-sm-4 col-md-3 float-right">
                                        <input type="text" name="search_text_nonpenduduk" class="form-control form-control-sm" placeholder="Search" id="search_text_nonpenduduk">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col table-responsive">
                                        ...
                                        <table class="table table-striped table-hover no-wrap small table-sm" id="nonpenduduk">
                                            <thead class="text-center">
                                                <th class="align-middle p-2">Aksi</th>
                                                <th class="align-middle">No</th>
                                                <th class="align-middle" hidden="">ID</th>
                                            ...
                                            <tbody id="show_data_nonpenduduk"></tbody>
                                        </table>
