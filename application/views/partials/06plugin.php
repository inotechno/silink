    ...
    <script src="<?= base_url('assets') ?>/assets/extra-libs/taskboard/js/jquery.ui.touch-punch-improved.js"></script>
    <script src="<?= base_url('assets') ?>/assets/extra-libs/taskboard/js/jquery-ui.min.js"></script>
